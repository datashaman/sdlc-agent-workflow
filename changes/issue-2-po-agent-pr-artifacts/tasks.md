...
1. Document the reusable change artifact structure.
...
4. Update agent role documentation.
...
5. Update README source-of-truth wording.
...
6. Check consistency against issue #2 acceptance criteria.
