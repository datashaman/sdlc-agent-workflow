...
8. Implementation and acceptance loop, until both technical and product acceptance pass:
   ...
   1. Implementation Agent implements the tasks. `[A]`
   2. Implementation Agent updates progress in the PR. `[A]`
   ...
   6. If technical changes are required, Implementation Agent fixes the implementation and the implementation loop restarts. `[A]`
   ...
   11. If behavior changes are required, Implementation Agent fixes the implementation and the implementation loop restarts. `[A]`
